    ...
    <div className="min-h-screen bg-teal-50">
      <div className="mx-auto max-w-3xl space-y-6 px-6 py-8">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-xl font-bold text-gray-900">Quick BoM — No RFP Required</h1>
            <p className="text-sm text-gray-500">
              Upload a BoQ template and get instant pricing without an RFP session
            </p>
          </div>
        </div>
        ...
        <div className="rounded-xl border border-teal-200 bg-white shadow-sm">
          ...
          <div className="space-y-5 px-6 py-5">
            ...
            <div className="space-y-1.5">
              ...
              <div
                ...
                className={`cursor-pointer rounded-lg border-2 border-dashed px-6 py-8 text-center transition-colors ${
                  dragging ? "border-teal-400 bg-teal-50" : "border-gray-300 bg-gray-50 hover:border-teal-400"
                }`}
              >
                <input
                  ref={inputRef}
            ...
            <button
              ...
              disabled={!canSubmit}
              className="flex items-center gap-2 rounded-lg bg-teal-600 px-6 py-2.5 text-sm font-medium text-white transition-colors hover:bg-teal-700 disabled:cursor-not-allowed disabled:opacity-50"
            >
              {loading && <Spinner />}
          ...
          <div className="rounded-xl border border-teal-200 bg-white shadow-sm">
            <div className="border-b border-teal-100 px-6 py-4">
              <h2 className="text-base font-semibold text-gray-800">
                2 — Results{projectName ? ` — ${projectName}` : ""}
              </h2>
            </div>
            ...
            <div className="space-y-5 px-6 py-5">
              ...
              <a
                ...
                className="flex items-center justify-center gap-2 rounded-lg bg-teal-600 px-6 py-3 text-sm font-medium text-white transition-colors hover:bg-teal-700"
              >
